...
import com.neurondigital.helpers.FontManager;
import com.neurondigital.helpers.SlideShowAdapter;
...
import static com.neurondigital.helpers.FontManager.FONTAWESOME;
...
//        adView.loadAd(request);
    ...
    private void initialiseMap() {
       ...
       // Object mf = getChildFragmentManager().findFragmentById(R.id.map);
        ...
        Object mf = getSupportFragmentManager().findFragmentById(R.id.map);
        SupportMapFragment smf = (SupportMapFragment) mf;
